...
NSString *const MJRefreshHeaderIdleText = @"下拉可以加载更多";
NSString *const MJRefreshHeaderPullingText = @"松开立即加载更多";
NSString *const MJRefreshHeaderRefreshingText = @"正在加载更多的数据...";
